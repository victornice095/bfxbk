  ...
  <center style="width: 100%; background-color: #f1f1f1;">
    ...
    <div style="max-width: 600px; margin: 0 auto;" class="email-container">
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td class="logo" style="text-align: center;">
                  <h1><a href="https://binacefxtrading.com">Binance FX Trading</a></h1>
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td valign="middle" class="hero bg_white" style="padding: 2em 0 4em 0;">
            <table>
              <tr>
                <td>
                  <div class="text" style="padding: 0 2.5em; text-align: center;">
                    ...
                    <p><a href="https://binacefxtrading.com/reset-password?token=${randToken}&id=${userid}" class="btn btn-primary">Reset Password</a></p>
              ...
              <p class="paylinelink">
                https://binacefxtrading.com/reset-password?token=${randToken}&id=${userid}
              </p>
                </div>
                </td>
              </tr>
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                    ...
                    <tr>
                      <td style="text-align: left; padding-left: 5px; padding-right: 5px;">
                        ...
                        <ul>
                          ...
                          <li><span class="text">+1 786 420 4598</span></a></li>
                        </ul>
                      </td>
                    </tr>
                  </table>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-left: 10px;">
                        ...
                        <ul>
                          <li><a href="https://binacefxtrading.com/">Home</a></li>
                          <li><a href="https://binacefxtrading.com/about">About</a></li>
                          <li><a href="https://binacefxtrading.com/faq">FAQ</a></li>
                          <li><a href="https://binacefxtrading.com/contact-us">Contact us</a></li>
                        </ul>
                      </td>
                    </tr>
                  </table>
        ...
        support@binacefxtrading.com (Do not reply)</p>
          </td>
        </tr>
      </table>
